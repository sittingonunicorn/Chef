...
public class Menu {
    ...
    static {
        spicy_salad = new Salad("Spicy salad", new Vegetable(Ingredients.SWEET_RED_PEPPER, 30, false),
        ...
        vinaigrette = new Salad("Vinaigrette", new Vegetable(Ingredients.POTATOES, 25, true),
        ...
        spring = new Salad("Spring salad", new Vegetable(Ingredients.TOMATOES, 130, false),
